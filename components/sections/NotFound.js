...
export default function NotFound() {
  return (
    <div className="container mt-24 mx-auto justify-around items-center flex flex-col lg:flex-row">
      <div className="flex flex-col m-10 w-auto md:w-[455px]">
        ...
        <Link href="/">
          <Button className={'w-fit'} text={'Kthehu mbrapa'} />
        </Link>
      </div>
